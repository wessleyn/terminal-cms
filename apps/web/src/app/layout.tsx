...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL || 'https://wessleyn.me'
  ),
  title: "Wessley's Terminal",
  description:
    'Software Developer Portfolio showcasing projects and skills in a terminal-themed interface',
  keywords:
    'software developer, portfolio, programming, coding, terminal, developer',
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      data-bs-theme={defaultColorScheme}
      {...mantineHtmlProps}
    >
      <head>
        <meta

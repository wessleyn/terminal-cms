...
-- CreateEnum
CREATE TYPE "BlogTagType" AS ENUM ('BLOG', 'INTERNAL');
...
CREATE TABLE "BlogTag" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT NOT NULL DEFAULT 'Short description of the tag',
    "slug" TEXT NOT NULL,
    "color" TEXT NOT NULL DEFAULT 'blue',
    "type" "BlogTagType" NOT NULL DEFAULT 'BLOG',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "CategorySubscriber_email_categoryId_key" ON "CategorySubscriber"("email", "categoryId");
...
-- AddForeignKey
ALTER TABLE "CategorySubscriber" ADD CONSTRAINT "CategorySubscriber_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "BlogCategory"("id") ON DELETE CASCADE ON UPDATE CASCADE;
